...
x0=np.random.binomial(n=10,p=0.5,size=(10000,10))
x1=np.random.binomial(n=10,p=0.5,size=(10000,200))
x2=np.random.binomial(n=10,p=0.5,size=(10000,1000))
...
plt.title("Distribution of means of random numbers using Binomial distribution")
plt.show()
