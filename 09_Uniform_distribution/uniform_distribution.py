...
x0=np.random.uniform(low=0,high=1,size=(10000,20))
x1=np.random.uniform(low=0,high=1,size=(10000,100))
x2=np.random.uniform(low=0,high=1,size=(10000,1000))
...
plt.title("Distribution of means of random numbers using Uniform distribution")
plt.show()
