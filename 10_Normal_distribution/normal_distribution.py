...
x0=np.random.normal(loc=0,scale=1,size=(10000,20)) #loc=location
x1=np.random.normal(loc=0,scale=1,size=(10000,100))
x2=np.random.normal(loc=0,scale=1,size=(10000,1000))
...
plt.title("Distribution of means of random numbers using Normal distribution")
plt.show()
